...
def loader_returning_patient(birth_number):
    return Patient(
...
def loader_raising_not_found(birth_number):
    raise PatientNotFound()


def loader_raising_api_error(birth_number):
    raise APIError()


def loader_raising_not_available(birth_number):
